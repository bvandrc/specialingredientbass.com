...
const GridCards = ({ initiallyOpen }: Pick<GridCardProps, 'initiallyOpen'>) => [
  ...
  <GridCard title="Wompy Dubstep" initiallyOpen={initiallyOpen}>
    <SoundcloudTrack
      ...
      additionalInfo={
        <>
          <i>True</i> riddim, carefully picked. If you're not a fan of riddim yet, try this one out.
          Headphones recommended, Lotta wild sounds bouncing around the 3D space in this one.
        </>
      }
    />
    <SoundcloudTrack
