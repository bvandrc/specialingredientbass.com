...
export const GridCardTitle = ({
  ...
  <div
    className="flex items-center justify-center relative top-0 m-2.5 p-2.5 font-[Roboto_Condensed] rounded-xl bg-[darkslateblue] cursor-pointer hover:shadow-[0_0_10px_2px_cyan] hover:text-glow-[darkcyan]"
    role="button"
    tabIndex={0}
